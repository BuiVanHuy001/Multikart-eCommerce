    ...
    Prism = function () {
        var e = /\blang(?:uage)?-(\w+)\b/i, t = 0, a = _self.Prism = {
            util: {
                ...
                var o = t.textContent, u = {element: t, language: i, grammar: s, code: o};
                ...
                e:for (var l in t) if (t.hasOwnProperty(l) && t[l]) {
                    ...
                    for (var u = 0; u < o.length; ++u) {
                        var g = o[u], c = g.inside, p = !!g.lookbehind, d = !!g.greedy, m = 0, h = g.alias;
                        ...
                        for (var y = 0, b = 0; y < i.length; b += i[y].length, ++y) {
                            ...
                            if (!(v instanceof r)) {
                                ...
                                if (w) {
                                    p && (m = w[1].length);
                                    var P = w.index + m, w = w[0].slice(m), x = P + w.length, C = v.slice(0, P),
                                        E = v.slice(x), N = [y, k];
                                    C && N.push(C);
...
//# sourceMappingURL=prism.min.js.mapÎ